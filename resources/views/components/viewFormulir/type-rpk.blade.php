<div class="p-4 sm:ml-64">
    <div class="bg-white p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        ...
        <div class="grid md:grid-cols-4 md:gap-6">
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-input readonly required name="type_rpk.nomor_siupper" type="text" placeholder="234134234234" label="Nomor SIUPPER" />
            </div>
            <div class="relative z-999 w-full mb-6 group">
                <x-splade-input date disabled required name="type_rpk.tgl_siupper" type="text" placeholder="Pilih tanggal..." label="Tanggal SIUPPER" />
            </div>
            <div class="relative z-0 w-full mb-6 group">
            ...
            <div class="relative z-999 w-full mb-6 group">
                <x-splade-input date disabled v-if="form.type_rpk.type_rpk == 'perpanjangan'" required name="type_rpk.tgl_rpk_sebelumnya" type="text" placeholder="Pilih tanggal..." label="Tanggal RPK Sebelumnya" />
            </div>
        </div>
    </div>
</div>