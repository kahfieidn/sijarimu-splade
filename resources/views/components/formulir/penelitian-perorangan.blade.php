<div class="p-4 sm:ml-64">
    <div class="bg-white p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        ...
        <div class="relative z-0 w-full mb-6 group">
            <x-splade-input required name="lembaga" type="text" placeholder="Tulis Nama Lembaga / Instansi / Perusahaan" label="Nama Lembaga / Instansi / Perusahaan" />
        </div>
        <div class="relative z-0 w-full mb-6 group">
        ...
        <div class="grid md:grid-cols-3 md:gap-6">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-input required name="lokasi_penelitian" type="text" placeholder="DPMPTSP Provinsi Kepulauan Riau, Dikominfo Kepri" label="Lokasi Penelitian" />
            </div>
        </div>
    </div>
</div>