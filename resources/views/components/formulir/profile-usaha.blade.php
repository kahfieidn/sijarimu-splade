    ...
    <div class="bg-white p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-input required name="npwp" type="text" placeholder="NPWP" label="NPWP" />
            </div>
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-input required name="perusahaan" type="text" placeholder="Perusahaan" label="Perusahaan" />
            </div>
        </div>
        <div class="grid md:grid-cols-1 md:gap-6">
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-textarea required name="alamat" type="text" placeholder="Alamat" label="Alamat" autosize />
            </div>
        </div>
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-select name="domisili" type="text" placeholder="Domisili" label="Domisili" required>
            ...
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-select name="provinsi_domisili" type="text" placeholder="Provinsi" label="Provinsi" required>
                    <option value="Kepulauan Riau">Kepulauan Riau</option>
                </x-splade-select>
            </div>
        </div>
        <x-splade-submit label="Simpan & Lanjutkan" />
    </div>
</div>
<x-splade-submit />