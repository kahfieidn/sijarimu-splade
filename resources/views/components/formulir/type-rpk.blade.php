<div class="p-4 sm:ml-64">
    <div class="bg-white p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-input required name="jenis_kapal" type="text" placeholder="Cth : Kapal Penumpang / Kapal Barang / dll" label="Jenis Kapal" />
            </div>
        </div>
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-input required name="isi_kotor" type="text" placeholder="Cth : GT. 20 No. 124/GGg" label="Isi Kotor/Bobot Mati" />
            </div>
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-input required name="tenaga_penggerak" type="text" placeholder="Cth : YAMAHA 6 x 200 PK" label="Tenaga Penggerak" />
            </div>
        </div>
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-input required name="status_kepemilikan_kapal" type="text" placeholder="Cth : Keagenan Dioperasikan" label="Status Kepemilikan Kapal" />
            </div>
            <div class="relative z-0 w-full mb-6 group">
                <x-splade-input required name="kapasitas_angkut" type="text" placeholder="Cth : 14 (empat belas) orang" label="Kapasitas Angkut" />
            </div>
        </div>
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-6 group">
