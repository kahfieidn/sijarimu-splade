    ...
    <div class="bg-white p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-999 w-full mb-6 group">
                <x-splade-select disabled choices name="type_rpk.type_rpk" label="Tipe Kepengurusan Izin">
            ...
            <div class="relative z-999 w-full mb-3 group">
                <x-splade-select disabled choices name="type_rpk.type_gt" label="Jenis Isi Kotor GT/Bobot Mati (DWT) ">
                    <option disabled value="">Pilih salah satu...</option>
