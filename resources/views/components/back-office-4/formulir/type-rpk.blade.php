    ...
    <div class="bg-white p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        ...
        <div class="grid md:grid-cols-3 md:gap-6">
            ...
            <div class="relative z-999 w-full mb-6 group">
                <x-splade-input date required name="tgl_izin_terbit" placeholder="Pilih tanggal..." type="text" label="Tanggal Izin" />
            </div>
            <div class="relative z-999 w-full mb-6 group">
                <x-splade-input date required name="tgl_izin_terbit_exp" placeholder="Pilih tanggal..." type="text" label="Tanggal Expire Izin" />
            </div>
        </div>
        <iframe class="mt-4" src="{{ route('dashboard.cetak.perizinan.request', [$pemohon->perizinan_id, $pemohon->id])}}" width="100%" height="500"></iframe>
        </div>
