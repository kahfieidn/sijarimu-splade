...
namespace App\Tables\Verifikator1;
...
class Permohonans extends AbstractTable
{
    ...
    public function for()
    {
        return Permohonan::query()->where('status_permohonan_id', 7);
    }
    ...
    public function configure(SpladeTable $table)
    {
        $table
            ...
            ->rowLink(fn (Permohonan $pemohon) => route('verifikator-1.show', $pemohon->id))
            ->column('actions')
            ->paginate(5);
